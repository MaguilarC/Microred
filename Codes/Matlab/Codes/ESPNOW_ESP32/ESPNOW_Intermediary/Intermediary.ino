...
void mod_receptor(){ //filtro de a que modulo
   ...
   if(myData.id_mod==1){
    ...
    sprintf(data_ser_out,formato,1,lect[0],2,lect[1]);
   ...
   if(myData.id_mod==2){
    ...
    sprintf(data_ser_out,formato,3,lect[2],4,lect[3]);
    Serial2.write(data_ser_out);
    /*Serial.print(myData.id_mod);Serial.print(";");
   ...
   if(myData.id_mod==3){
    ...
    sprintf(data_ser_out,formato,5,lect[4],6,lect[5]);
    Serial2.write(data_ser_out);
    /*Serial.print(myData.id_mod);Serial.print(";");
   ...
   if(myData.id_mod==4){
    ...
    sprintf(data_ser_out,formato,7,lect[6],8,lect[7]);
    Serial2.write(data_ser_out);
    /*Serial.print(myData.id_mod);Serial.print(";");
   ...
   if(myData.id_mod==5){
    ...
    sprintf(data_ser_out,formato,9,lect[8],10,lect[9]);
    Serial2.write(data_ser_out);
    /*Serial.print(myData.id_mod);Serial.print(";");
   ...
   if(myData.id_mod==6){
    ...
    sprintf(data_ser_out,formato,11,lect[10],12,lect[11]);
    Serial2.write(data_ser_out);
    /*Serial.print(myData.id_mod);Serial.print(";");
   ...
   if(myData.id_mod==7){
    ...
    sprintf(data_ser_out,formato,13,lect[12],14,lect[13]);
    Serial2.write(data_ser_out);
    /*Serial.print(myData.id_mod);Serial.print(";");
   ...
   if(myData.id_mod==8){
    ...
    sprintf(data_ser_out,formato,15,lect[14],16,lect[15]);
    Serial2.write(data_ser_out);
